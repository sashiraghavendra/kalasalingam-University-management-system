...
public class Kalasalingam {
    ...
    static long s_bal = 125000;  // Used ONLY for semester fee
    ...
    public static void fees(Scanner sc, long reg) {
        ...
        if (f.creg == reg) {
            ...
            if (f.pay <= s_bal) {
                f.paid += f.pay;
                s_bal -= f.paid;
                System.out.println("Your new semester fee balance is " + s_bal);
                System.out.println("Semester fee paid successfully.\n");
            } else {
    ...
    public static void hfees(Scanner sc, long reg) {
        ...
        if (h.creg == reg) {
            ...
            System.out.println("2. Non attached 4 shared - ₹64,500");
            System.out.println("3. Attached 4 shared - ₹74,500");
            System.out.println("4. AC Non attached 4 shared - ₹83,500");
            System.out.println("5. AC attached - ₹97,500");
            h.ch = sc.nextInt();

            // Assign expected fee
            switch (h.ch) {
                case 1: h.expectedFee = 59500; break;
                case 2: h.expectedFee = 64500; break;
                case 3: h.expectedFee = 74500; break;
                case 4: h.expectedFee = 83500; break;
                case 5: h.expectedFee = 97500; break;
                default:
            ...
            // Hostel Payment
            System.out.print("Enter hostel fee amount to pay: ₹");
            long paid = sc.nextLong();

            if (paid == h.expectedFee) {
                System.out.println("\n✅ Hostel fee paid successfully: ₹" + paid);
                ...
                switch (h.ch) {
                    case 1: System.out.println("Annexure 5 shared"); break;
                    case 2: System.out.println("Non attached 4 shared"); break;
                    case 3: System.out.println("Attached 4 shared"); break;
                    case 4: System.out.println("AC Non attached 4 shared"); break;
                    case 5: System.out.println("AC attached 4 shared"); break;
                }

                System.out.print("Mess type: ");
                switch (h.mess) {
                    case 1: System.out.println("South-Indian"); break;
                    case 2: System.out.println("North-Indian"); break;
                }

                System.out.print("Diet type: ");
                switch (h.type) {
                    case 1: System.out.println("Vegetarian"); break;
                    case 2: System.out.println("Non Vegetarian"); break;
                }

            } else {
                System.out.println("❌ Payment failed. You must pay the full hostel fee: ₹" + h.expectedFee);
            }
